...
Du kannst auch den vollständigen Download inklusive Demo von [https://www.json-sql.de/JsonSQL.zip](https://www.json-sql.de/JsonSQL.zip) herunterladen.

---

**© 2024–2025 JsonSQL Team**  
🔗 Projektseite: [https://www.json-sql.de](https://www.json-sql.de)  
